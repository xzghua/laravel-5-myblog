...
<head>
    ...
    <link rel="stylesheet" href="/Admin/assets/css/extra-pages.css">
...
<section class="page-error">
    ...
    <div class="error-page">
        ...
        <div class="error-content">
            ...
            <p>
                We could not find the page you were looking for. Meanwhile, you may <a class="error-link" href='/home'>return to dashboard</a> or try using the search form.
            </p>
