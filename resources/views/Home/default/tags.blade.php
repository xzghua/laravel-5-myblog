...
@section('content')
    ...
    <section id="hero" class="scrollme">
        <div class="container-fluid element-img" style="background: url(http://obq9881x1.bkt.clouddn.com/yanhua-001.jpg) no-repeat center center fixed;background-size: cover">
            <div class="row">
