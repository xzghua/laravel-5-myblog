...
@section('content')
    ...
    <section id="hero" class="scrollme">
        <div class="container-fluid element-img" style="background: url('/Home/default/img/category.jpg') no-repeat center center fixed;background-size: cover">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="row boxes">
                        @if (!empty($artList->toArray()['get_article']))

                            @foreach( $artList->toArray()['get_article'] as $key => $item)
